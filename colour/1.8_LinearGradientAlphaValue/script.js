...
var actRandomSeed = 0;
// define and initialise a variable to be
// used as the alpha value for color.
// value of 27 will give a dark appearance
var alphaValue = 27;
  ...
  for (var i = rowCount; i >= 0; i--) {
    ...
    for (var ii = 0; ii < parts.length; ii++) {
      ...
      if (random() < 0.45) {
        ...
        var col1 = color(0);
        // add the alpha value to override a default value
