...
function centerGradient(x1, y1, r1, x2, y2, r2, c1, c2) {
  ...
  var cx = x1 + (x2 - x1) / 2;
  var cy = y1 + (y2 - y1) / 2;
//  create the gradient passing in the same starting
// co-ordinates for both circles then interpolating
// between o and the greater of height or width of
// the each rectagle to ensure even interpolation
// of the color
